...
var NimbusecAPI = function (key, secret, options) {
    ...
    this._key = key;
    this._secret = secret;
    this._request = new oauth.OAuth(
        null, null, /* No token exchange */
        this._key,
        this._secret,
        '1.0',
        null, /* No authorize callback */
        'HMAC-SHA1'
    );
};
 ...
 */
NimbusecAPI.prototype.findDomainResults = function (filter, callback) {
 ...
 */
NimbusecAPI.prototype.updateDomainResult = function (resultID, result,
                                                     callback) {
    this._put('/domain/' + domainID + '/result', domain, callback);
};
 ...
 * @method _getOrDelete
 * @private
 * @param {function} getOrDeleteFn reference to the get or delete function of
 * the oauth requester
 ...
 * @param {?NimbusecAPI~Error} error Error object if error occurred
 * @param {?Object} data Object returned by API, null if error occured
 */
NimbusecAPI.prototype._getOrDelete = function (getOrDeleteFn, uri, callback) {
    var that = this;
    getOrDeleteFn(
        this._options.baseURL + uri,
        null, null, /* No token exchange */
        function (err, data, response) {
            that._parseResponse(err, data, response, callback);
        }
    );
};
 ...
 * @method _postOrPut
 * @private
 * @param {function} postOrPutFn reference to the post or put function of the
 * oauth requester
 * @param {string} uri URI of the resource
 * @param {?string} filter optional filter
 * @param {NimbusecAPI~apiCallCallback} callback callback called at end of
 ...
 * @instance
 */
NimbusecAPI.prototype._postOrPut = function (postOrPutFn, uri, obj, callback) {
    var that = this;
    postOrPutFn(
        this._options.baseURL + uri,
        null, null, /* No token exchange */
 ...
 * @instance
 */
NimbusecAPI.prototype._parseResponse = function (err, data, response,
                                                 callback) {
...
NimbusecAPI.prototype._get = function (uri, filter, callback) {
    ...
    this._getOrDelete(this._request.get.bind(this._request), uri, callback);
};
...
NimbusecAPI.prototype._delete = function (uri, callback) {
    this._getOrDelete(this._request.delete.bind(this._request), uri, callback);
};
...
NimbusecAPI.prototype._post = function (uri, obj, callback) {
    this._postOrPut(this._request.post.bind(this._request), uri, obj, callback);
};
...
NimbusecAPI.prototype._put = function (uri, obj, callback) {
    this._postOrPut(this._request.put.bind(this._request), uri, obj, callback);
};
 ...
 * @property {string} status status of the result (pending, acknowledged,
 * falsepositive, removed)
